      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5 mt-2">
            ...
            <span className="text-gray-500 text-xs font-medium">{address.phone}</span>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3.5 flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <span className="font-bold text-gray-900 text-base">
              MyAgro <span className="text-[#2E7D32]">Checkout</span>
            </span>
          </div>
                  ...
                  {paymentMethod === 'mobile' && (
                    <div className="pt-4 mt-1 border-t border-gray-50">
                      ...
                      <input
                        ...
                        className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-gray-800 placeholder-gray-300 focus:outline-none focus:border-[#2E7D32] focus:ring-2 focus:ring-[#2E7D32]/10 transition-all"
                      />
                    </div>
                  )}
                    ...
                    <div className="pt-4 mt-1 border-t border-gray-50">
                      <div className="flex items-start gap-3 p-3.5 bg-amber-50 border border-amber-100 rounded-xl">
                        ...
                        <p className="text-xs text-amber-700 leading-relaxed">
                          You will pay <strong>GH₵ {total.toFixed(2)}</strong> in cash when your
